...
if edad <= 0 or edad > 110:
    print("Edad inválida. Por favor ingrese una edad entre 1 y 110.")
elif edad < 12:
    print("Niño/a")
elif edad < 18:
    print("Adolescente")
...
# Paso 1: Crear lista de 50 números aleatorios entre 1 y 100
numeros_aleatorios = [random.randint(1, 100) for i in range(50)]

# Paso 2: Calcular estadísticos
media = mean(numeros_aleatorios)
mediana = median(numeros_aleatorios)
moda = mode(numeros_aleatorios)

# Paso 3: Imprimir los valores
print("Lista de números:", numeros_aleatorios)
print("Media:", media)
print("Mediana:", mediana)
print("Moda:", moda)

# Paso 4: Determinar el tipo de sesgo
...
if magnitud < 0:
    print("Magnitud inválida. Debe ingresar un número positivo.")
elif magnitud < 3:
...
dia = int(input("Ingrese el número del día (1 a 31): "))
